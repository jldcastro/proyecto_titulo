  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-users"></i> <span>Crear Usuarios</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="{{ url('/perfil/create') }}"><i class="fa fa-user"></i>Agregar Tipo Usuario</a></li>
        ...
        <li class="treeview">
                  <a href="#">
                    <i class="fa fa-users"></i> <span>Permisos Usuarios</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li class="active"><a href="#"><i class="fa fa-user"></i>Agregar Permiso Usuario</a></li>
                  </ul>
                </li>
        <li class="treeview">
          <a href="#">
